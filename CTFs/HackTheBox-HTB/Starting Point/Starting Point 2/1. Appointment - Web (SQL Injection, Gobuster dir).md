...
3. **Vemos que hay encendido un servidor web (Apache) y vamos a usar [[Gobuster]] para listar directorios (`dir`) dentro de la web escribiendo la dirección de la máquina objetivo y usando una wordlist. Vamos a instalarlo y lo usamos de la siguiente manera:**
```shell
